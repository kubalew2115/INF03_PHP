...
<body>
    ...
    <main>
        ...
        <?php
            $query1 = "SELECT swinki.data_ur, swinki.miot, rasy.rasa FROM `swinki` JOIN rasy ON rasy.id = swinki.rasy_id WHERE rasy.id = 7 GROUP BY swinki.data_ur";
        ...
        <?php
            $query2 = "SELECT imie, cena, opis FROM `swinki` WHERE rasy_id = 7";
